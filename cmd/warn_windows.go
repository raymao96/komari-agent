...
// ShowToast 在用户态中执行
func ShowToast() {
	title := "Lite is Running"
	message := "The remote control software \"Lite\" is running, which allows others to control your computer. If this was not initiated by you, please terminate the program immediately."

	const aumid = "Lite.Monitor.Agent"
	const linkName = "Lite Warning (Auto Delete Later)"
...
func ensureStartMenuShortcut(aumid, linkName string) error {
	...
	_, _ = oleutil.PutProperty(shortcut, "Description", "Lite Agent")
	// 设置 AUMID
