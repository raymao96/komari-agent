...
type Config struct {
	...
	RemoteControlEnabled bool    `json:"remote_control_enabled" env:"AGENT_REMOTE_CONTROL_ENABLED"`   // 启用远程控制（终端、文件、exec、MCP）
...
// RemoteControlEnabled reports whether remote terminal, files, exec, and MCP are on.
